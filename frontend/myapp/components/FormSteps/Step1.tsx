  ...
  return (<div>
    <div className="flex flex-col h-screen items-center justify-center ">
        <div className='flex items-center justify-center'>
            ...
            <h1 className='text-3xl text-center mb-5 '>기본 정보를 입력하시면 <span className=''><br /></span>
딱 맞는 고수의 견적을 보내드립니다.</h1>
         

         {/* Name */}
         <div>
         <label htmlFor="input2" className="block text-sm font-medium text-gray-500 dark:text-gray-100">이름</label>
         ...
         {/* Phone number */}
         <div className='mt-7'>
           <label htmlFor="input2" className="block text-sm font-medium text-gray-500 dark:text-gray-100">전화번호</label>
