...
const EventsModal: FC<GalleryProps> = ({ onClose }) => {
  ...
  return (
    ...
    >
      {/* THis button */}
      <motion.div className="fixed left-[50%] top-[170px] z-10 flex h-10 w-10 cursor-pointer items-center justify-center rounded-b-[40%] bg-white">
        <motion.button
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 2.1, duration: 0.5, ease: [0.22, 1, 0.36, 1] }}
          className="  h-6  w-6 rounded-md border-[1.5px] border-[#49111c]"
          onClick={onClose}
        >
          <motion.svg
            width="20"
      ...
      <motion.div className="mx-16 mt-0 flex flex-wrap justify-between ">
        ...
        >
          <motion.div
            ...
            className="event_range_wrapper relative m-1 h-20 w-20 rounded-lg border text-[12px] text-[#49111c] hover:bg-gray-50 hover:text-[#F25287] peer-checked:border-[#F25287]  peer-checked:text-[#F25287] md:m-2 md:h-16 md:w-[10rem] 
    md:text-[15px] xl:m-2  "
          >
            <button
              id="wedding"
            ...
            >
              <Image
                ...
                alt="wedding"
                className="mx-2 h-10 w-10 md:h-[40px] md:w-[40px]"
              />
              가족 개인행사
            </label>
          </motion.div>
        ...
        >
          <motion.div
            whileTap={checkboxAnimations}
            className="event_range_wrapper relative m-1 h-20 w-20  cursor-pointer select-none rounded-lg border text-[12px] text-[#49111c] hover:bg-gray-50 hover:text-[#2563EB] peer-checked:border-[#2563EB]   peer-checked:text-[#2563EB] md:m-2 md:h-16 md:w-[10rem] md:text-[15px] xl:m-2 "
          >
            <button
            ...
            >
              <Image
                ...
                alt="business"
                className="mx-2 h-11 w-11 md:h-[40px] md:w-[40px]"
              />
              기업 이벤트
            </label>
          </motion.div>
        ...
        >
          <motion.div
            whileTap={checkboxAnimations}
            className="event_range_wrapper relative m-1 h-20 w-20 cursor-pointer select-none rounded-lg border text-[12px] text-[#49111c] hover:bg-gray-50  hover:text-[#047857] peer-checked:border-[#047857] peer-checked:text-[#047857] md:m-2 md:h-16 md:w-[10rem] md:text-[15px] xl:m-2"
          >
            <button
        ...
        >
          <motion.div
            whileTap={checkboxAnimations}
            className="event_range_wrapper relative m-1 h-20 w-20 cursor-pointer select-none rounded-lg border text-[12px] text-[#49111c] hover:bg-gray-50  hover:text-[#7C3AED] peer-checked:border-[#7C3AED] peer-checked:text-[#7C3AED] md:m-2 md:h-16 md:w-[10rem] md:text-[15px] xl:m-2 "
          >
            <button
        ...
        >
          <motion.div
            whileTap={checkboxAnimations}
            className="event_range_wrapper relative m-1 h-20 w-20 cursor-pointer select-none rounded-lg border text-[12px] text-[#49111c] hover:bg-gray-50  hover:text-[#9D174D] peer-checked:border-[#9D174D] peer-checked:text-[#9D174D] md:m-2 md:h-16 md:w-[10rem] md:text-[15px] xl:m-2 "
          >
            <button
        ...
        >
          <motion.div
            whileTap={checkboxAnimations}
            className="event_range_wrapper relative m-1 h-20 w-20 cursor-pointer select-none rounded-lg border text-[12px] text-[#49111c] hover:bg-gray-50  hover:text-[#FE0000] peer-checked:border-[#FE0000] peer-checked:text-[#FE0000] md:m-2 md:h-16 md:w-[10rem] md:text-[15px] xl:m-2 "
          >
            <button
            ...
            >
              <svg
                ...
                className="lucide lucide-beef mx-2 h-10 w-10 md:h-[40px] md:w-[40px]"
              >
        ...
        >
          <motion.div
            whileTap={checkboxAnimations}
            className="event_range_wrapper relative m-1 h-20 w-20 cursor-pointer select-none rounded-lg border text-[12px] text-[#49111c] hover:bg-gray-50  hover:text-[#F8B400] peer-checked:border-[#F8B400] peer-checked:text-[#F8B400] md:m-2 md:h-16 md:w-[10rem] md:text-[15px] xl:m-2 "
          >
            <button
            ...
            >
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-dessert mx-2 h-10 w-10 md:h-[40px] md:w-[40px]"
              >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className=" corousel mx-16  mt-10 overflow-hidden"
      >
        <motion.div
