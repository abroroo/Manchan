...
const Landing = () => {
  ...
  return (
    ...
    <div className='h-screen '>
      ...
      <h1 className='text-6xl font-bold text-white'>Manchan Food Service </h1>
    ...
    {/* <svg viewBox="0, 0, 150, 150" className=" absolute top -32 left-32 w-[150px] h-[150px]"><Polygon points="-17.365 49.24 -43.969 26.917 -50 -7.285 -32.635 -37.362 0 -49.24 32.635 -37.362 50 -7.285 43.969 26.917 17.365 49.24" /></svg> */}
      ...
      <Link className="flex mt-10 items-start justify-center " href= "/choose-date">
  
<button className='bg-transparent font-semibold text-white hover:text-white py-2 px-4 z-20'>Reserve </button>

</Link>

<g className=' absolute right-[533px] top-[425px]' transform="">
