...
import { cn, dayNames } from "../../utils/cn"
import {
  add,
  addDays,
  addHours,
...
import AvailableHours from "../../components/date/AvailableHours"
import TimesBar from "../../components/date/TimesBar"
    ...
    <div className="flex flex-col min-h-screen justify-center items-center gap-2 bg-stone-50">
      ...
      <div className={cn("flex flex-col gap-2 justify-center items-center")}>
        <span className="font-serif text-xl sm:text-2xl font-semibold text-teal-900 px-4 sm:px-2">
          Please choose the date and address of the event
        </span>
...
<div className="">
      ...
      <div className="flex flex-col gap-2 h-[380px] w-[380px] mt-12">
        {/* calendar header */}
      ...
      <div className={cn(calendarTouched ? "" : "hidden")}>
        ...
        {/* Search address bar */}
        <div className="ml-10 w-[27rem]">
        <span className="flex items-center w-full justify-center gap-1">
          <span>
            Please find the address of the event venue:
            {/* <span className="text-orange-950 font-semibold pl-1">
              {format(selectedDay, "dd MMMM yyyy").toString()}
            </span> */}
          </span>
