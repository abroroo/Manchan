...
import SmoothScroll from "../../components/Scolling/SmoothScrollHorizontal"
import {
  Birthday,
  Bussiness,
  Festival,
...
const EventsModal: FC<GalleryProps> = ({ onClose }) => {
  ...
  return (
    <motion.div
      ...
      className="fixed z-[110] mt-[84px] h-screen w-screen overflow-y-scroll  bg-[#fff] px-5 pb-40 md:overflow-y-hidden"
    >
      {/* Category buttons */}

      <motion.div className="mx-2 mt-2 flex flex-wrap justify-between md:mx-16 md:mt-0 ">
        <motion.div
