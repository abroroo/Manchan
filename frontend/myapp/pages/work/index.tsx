...
console.log('THis is selcted event: ', selectedEvent)
  return (<motion.div 
    ...
    className='z-[110] bg-[#fff] w-screen h-screen fixed overflow-y-scroll  md:overflow-y-hidden px-5 pb-40 mt-[84px]'>
...
<motion.div 
 className='mx-2 md:mx-16 mt-2 md:mt-0 flex flex-wrap justify-between '>
...
<motion.div 
    ...
    className='event_range_wrapper w-[6rem] h-10 md:w-[10rem] md:h-16 relative m-1 md:m-2 xl:m-2 text-[#49111c] border rounded-lg  peer-checked:border-[#F25287] peer-checked:text-[#F25287] hover:text-[#F25287] hover:bg-gray-50 
    text-[12px] md:text-[15px]  '>
      ...
      <Image width="40" height="40" src="/images/icons/wedding.png" alt="wedding" className='mx-1 md:mx-2 w-7 h-7 md:h-[40px] md:w-[40px]'/>
      가족 개인
      </label>
    </motion.div>
    </motion.div>
...
<motion.div
        whileTap={checkboxAnimations}
         className='event_range_wrapper w-[6rem] h-10 md:w-[10rem] md:h-16  relative m-1 md:m-2 xl:m-2 text-[#49111c] border rounded-lg cursor-pointer peer-checked:border-[#2563EB]   peer-checked:text-[#2563EB] hover:text-[#2563EB] hover:bg-gray-50 text-[11px] md:text-[15px] select-none '>
        <button 
        ...
        className='flex-start ' />
          ...
          <Image width="40" height="40" src="/images/icons/bussiness.png" alt="business" className='mx-1 md:mx-2 w-8 h-8 md:h-[40px] md:w-[40px]'/>
          기업 이벤트
          </label>
        </motion.div>
        </motion.div>
        ...
        <motion.div 
        whileTap={checkboxAnimations}
        className='event_range_wrapper w-[6rem] h-10 md:w-[10rem] md:h-16 relative m-1 md:m-2 xl:m-2 text-[#49111c] border rounded-lg  cursor-pointer peer-checked:border-[#047857] peer-checked:text-[#047857] hover:text-[#047857] hover:bg-gray-50 text-[12px] md:text-[15px] select-none'>
        ...
        onClick={() => setSelectedEvent('public')} className='flex-start' />
          ...
          <Image width="40" height="40" src="/images/icons/public.png" alt="public" className='mx-1 md:mx-2 w-7 h-7 md:h-[40px] md:w-[40px]'/>
          사회 단체
          </label>
        </motion.div>
        </motion.div>
        ...
        <motion.div 
        whileTap={checkboxAnimations}
        className='event_range_wrapper w-[6rem] h-10 md:w-[10rem] md:h-16 relative m-1 md:m-2 xl:m-2 text-[#49111c] border rounded-lg  cursor-pointer peer-checked:border-[#7C3AED] peer-checked:text-[#7C3AED] hover:text-[#7C3AED] hover:bg-gray-50 text-[11px] md:text-[15px] select-none '>
            ...
            <Image width="40" height="40" src="/images/icons/festival.png" alt="festival" className='mx-1 md:mx-2 w-7 h-7 md:h-[40px] md:w-[40px]'/>
            기관, 축제등
            </label>
        </motion.div>
        </motion.div>
        ...
        <motion.div 
        whileTap={checkboxAnimations}
        className='event_range_wrapper w-[6rem] h-10 md:w-[10rem] md:h-16 relative m-1 md:m-2 xl:m-2 text-[#49111c] border rounded-lg  cursor-pointer peer-checked:border-[#9D174D] peer-checked:text-[#9D174D] hover:text-[#9D174D] hover:bg-gray-50 text-[12px] md:text-[15px] select-none '>
        ...
        onClick={() => setSelectedEvent('birthday')} className='flex-start' />
          ...
          <Image width="40" height="40" src="/images/icons/birthday.png" alt="birthday" className='mx-1 md:mx-2 w-7 h-7 md:h-[40px] md:w-[40px]'/>
          <span className='flex'>
          스몰웨딩</span>
          </label>
        </motion.div>
        ...
        <motion.div 
        whileTap={checkboxAnimations}
        className='event_range_wrapper w-[6rem] h-10 md:w-[10rem] md:h-16 relative m-1 md:m-2 xl:m-2 text-[#49111c] border rounded-lg  cursor-pointer peer-checked:border-[#FE0000] peer-checked:text-[#FE0000] hover:text-[#FE0000] hover:bg-gray-50 text-[12px] md:text-[15px] select-none '>
        ...
        <motion.div 
        whileTap={checkboxAnimations}
        className='event_range_wrapper w-[6rem] h-10 md:w-[10rem] md:h-16 relative m-1 md:m-2 xl:m-2 text-[#49111c] border rounded-lg  cursor-pointer peer-checked:border-[#F8B400] peer-checked:text-[#F8B400] hover:text-[#F8B400] hover:bg-gray-50 text-[12px] md:text-[15px] select-none '>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#F8B400" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-dessert mx-1 md:mx-2 w-7 h-7 md:h-[40px] md:w-[40px]"><circle cx="12" cy="2" r="1"/><path d="M10.2 3.2C5.5 4 2 8.1 2 13a2 2 0 0 0 4 0v-1a2 2 0 0 1 4 0v4a2 2 0 0 0 4 0v-4a2 2 0 0 1 4 0v1a2 2 0 0 0 4 0c0-4.9-3.5-9-8.2-9.8"/><path d="M3.2 14.8a9 9 0 0 0 17.6 0"/></svg>
            핑거푸드
            </label>
        </motion.div>
        </motion.div>
        ...
        viewport={{once: true}}
         ...
         className=' corousel overflow-hidden  mt-2 md:mt-10 mx-2 md:mx-16'>
